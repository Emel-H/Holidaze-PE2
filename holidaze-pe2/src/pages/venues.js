    ...
    if(pop.length>0){
        return pop.map((venue) => ( 
            <Card className=" m-3" style={{ width: '18rem' }} key={venue.id}>
                ...
                <Card.Body>
                    <Card.Title aria-level={2} role="heading">{venue.name} </Card.Title>
        ...
        <main>
            ...
            <Container>
                <Row className="justify-content-center mt-5">
                    <Form.Control aria-label="search field" autoComplete="off" name="search" className="my-4 w-75" type="text" onChange={OnSearchChange} placeholder="Search"/>
                </Row>
