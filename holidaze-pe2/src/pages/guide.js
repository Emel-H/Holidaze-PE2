  ...
  return (
    <main>
      ...
      <Container className="px-md-5">
          ...
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body>
              <ol className="text-start">
                ...
                <li key={1}>
                  (Optional) if you have a specifc venue in mind, type in the
                  search field for dynamic search{" "}
                </li>
                <li key={2}>
                  Select the venue you are interested in by clicking view{" "}
                </li>
              </ol>
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="1">
            ...
            <Accordion.Body>
              <ol className="text-start">
                ...
                <li key={1}>
                  Go to the bottom of the page to view the booking form (Note:
                  if you are owner of the venue, you wll not see the booking
                  option){" "}
                </li>
          ...
          <Accordion.Item eventKey="2">
            ...
            <Accordion.Body>
              <ol className="text-start">
                ...
                <li key={2}>
                  You can now see a list of your bookings, and can click on the
                  view button to see the venue details{" "}
                </li>
              </ol>
            </Accordion.Body>
          </Accordion.Item>
        ...
        <p className="px-md-5 text-start">
          (Functionality for venue managers only)
        </p>
        <Accordion data-bs-theme="light" className="px-md-4">
          <Accordion.Item eventKey="0">
          ...
          <Accordion.Item eventKey="1">
            ...
            <Accordion.Body>
              <ol className="text-start">
                ...
                <li key={3}>
                  Click on the edit button of the venue you want to update
                </li>
                <li key={4}>
                  Fill in all the necessary fields and click update{" "}
                </li>
              </ol>
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="2">
            ...
            <Accordion.Body>
              <ol className="text-start">
                ...
                <li key={2}>You will now see a list of venues you manage</li>
                <li key={3}>
                  Click on the delete button of the venue you want to remove
                </li>
              </ol>
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="3">
            ...
            <Accordion.Body>
              <ol className="text-start">
                ...
                <li key={2}>You will now see a list of venues you manage</li>
                <li key={3}>
                  Click on the view bookings button of the venue you want to
                  examine
                </li>
                <li key={4}>
                  At the bottom of the venue page you can see a list of all the
                  bookings made{" "}
                </li>
              </ol>
            </Accordion.Body>
